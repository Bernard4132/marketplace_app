...
class PostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poster" do
    assert_difference('Poster.count') do
      post posters_url, params: { poster: { description: @poster.description, negotiate: @poster.negotiate, price: @poster.price, title: @poster.title, user_id: @poster.user_id } }
    end
  ...
  test "should update poster" do
    patch poster_url(@poster), params: { poster: { description: @poster.description, negotiate: @poster.negotiate, price: @poster.price, title: @poster.title, user_id: @poster.user_id } }
