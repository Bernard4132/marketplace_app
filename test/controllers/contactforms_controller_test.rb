...
class ContactformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contactform" do
    assert_difference('Contactform.count') do
      post contactforms_url, params: { contactform: { email: @contactform.email, message: @contactform.message, name: @contactform.name, phone: @contactform.phone } }
    end
  ...
  test "should update contactform" do
    patch contactform_url(@contactform), params: { contactform: { email: @contactform.email, message: @contactform.message, name: @contactform.name, phone: @contactform.phone } }
